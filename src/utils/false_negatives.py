...
def copy_real_images_to_false_negatives(image_folder, json_file):
...
if __name__ == "__main__":
    ...
    json_file = "/home/usluesyr/ai_image_detector/data/fake/test/results/gpt-5.2/prompt3/2026-01-20_18-46-16/results.json"
    copy_real_images_to_false_negatives(image_folder, json_file)
