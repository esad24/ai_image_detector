...
# ==========================
ROOT_FOLDER = "/home/usluesyr/ai_image_detector/data/fake"
...
def update_accuracy(file_path):
    try:
        ...
        detected_fake = data.get("detected_fake")
        image_count = data.get("image_count")

        # Check if required values exist and are valid
        if detected_fake is None or image_count is None:
